...
from app.api.routers import auth, users, spaces, knowledge, tags, attachments, search, audit, modules, agent, system, agent_keys
...
api_router.include_router(agent_keys.router, prefix="/agent-keys", tags=["Agent凭证"])
